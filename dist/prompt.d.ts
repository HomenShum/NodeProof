...
export declare const PACKAGE_COMMANDS: readonly ["init", "doctor", "gate", "hooks", "tooluse", "ci", "manifest", "docs", "template", "workflow", "ui", "resume", "report", "charts", "runner", "agents", "codex-loop", "codex", "providers", "mcp", "prompt", "this-repo"];
