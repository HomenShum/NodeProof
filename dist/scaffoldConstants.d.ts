 ...
 */
export declare const VERIFIER_WEAKENING_PATTERNS: readonly RegExp[];
/**
 ...
 */
export declare const DEFAULT_IMMUTABLE_FILES: readonly string[];
/**
 ...
 */
export declare const DEFAULT_PROTECTED_EXTRA_PATHS: readonly string[];
