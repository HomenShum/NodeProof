...
const ANCHORS: Array<[string, number, string]> = [
  ...
  ["public/app.js", 30, "function blockedMessage"],
  ["public/app.js", 42, "function normalizeTarget"],
  ["public/app.js", 51, "function githubRepo"],
  ["public/app.js", 63, "function githubCommand"],
  ["public/app.js", 108, "async function submitTarget"],
  ["public/app.js", 149, 'setStatus("blocked", blockedMessage(data)'],
  ["public/app.js", 160, 'submit.addEventListener("click"'],
  ["public/app.js", 161, 'input.addEventListener("keydown"'],
  ["public/styles.css", 198, "var(--accent-hover)"],
  ["public/styles.css", 207, "#ffb199"],
